(self.webpackChunk = self.webpackChunk || []).push([
  [400],
  {
    1496: function (e, t, a) {
      ...
      var x = function (e, t) {
          var a =
            ...
            i);
          return (
            a && (a.observe(e), S.set(e, t)),
            function () {
              a.unobserve(e), S.delete(e);
            }
          );
        },
        O = function (e) {
        ...
        z = o.default.forwardRef(function (e, t) {
          var a = e.sizes,
            r = e.srcSet,
            i = e.src,
            n = e.style,
      ...
      var N = (function (e) {
        function t(t) {
          ...
          ((a = e.call(this, t) || this).seenBefore = y && h(t)),
            ...
            (a.useIOSupport = !b && v && !a.isCritical && !a.seenBefore);
        ...
        return (
          ...
          (a.render = function () {
            var e = c(this.props),
              ...
              x = p || h;
            if (!x) return null;
            var N = !1 === this.state.fadeIn || this.state.imgLoaded,
              ...
              j = this.state.isHydrated ? g(x) : x[0];
            if (p)
              return o.default.createElement(
                v,
                {
                ...
                this.addNoScript &&
                  o.default.createElement("noscript", {
                    dangerouslySetInnerHTML: {
                      __html: O(
                        (0, l.default)({ alt: a, title: t, loading: w }, j, {
                          imageVariants: x,
                        })
                      ),
                    },
      ...
      N.propTypes = {
        resolutions: k,
        sizes: C,
        fixed: H(u.default.oneOfType([k, u.default.arrayOf(k)])),
        fluid: H(u.default.oneOfType([C, u.default.arrayOf(C)])),
    ...
    2323: function (e, t, a) {
      ...
      function l(e) {
        var t,
          a = e.data.markdownRemark,
          l = a.frontmatter.title,
          o = a.fields.tags;
        return (
          0 < o.length &&
            (t = o
              .map(function (e) {
                return r.createElement(i.Link, { to: "/tags/" + e }, e);
              })
              .reduce(function (e, t) {
                return [e, ", ", t];
              })),
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement("h1", { className: "title is-2" }, l),
                r.createElement(n.Z, {
                  fluid: a.frontmatter.cover.childImageSharp.fluid,
                }),
                r.createElement(
                  "div",
                  { className: "columns is-vcentered mt-1" },
                  r.createElement(
                    "div",
                    { className: "column" },
                    r.createElement(
                      "section",
                      { className: "heading subtitle is-6" },
                      r.createElement(
                        "p",
                        null,
                        r.createElement("time", null, a.frontmatter.time)
                      ),
                      r.createElement(
                        "p",
                        null,
                        (0, d.Z)(a.wordCount.words, "word"),
                        " |",
                        " ",
                        (0, d.Z)(a.timeToRead, "minute")
                      )
                    )
                  ),
                  r.createElement(
                    ...
                    r.createElement(
                      "section",
                      { className: "is-pulled-right heading subtitle is-6" },
                      t
                    )
                  )
                ),
...
//# sourceMappingURL=component---src-templates-post-jsx-8a952e6cb75e399a7dbd.js.map
